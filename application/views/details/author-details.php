...
<head>
    ...
    // `d` is the original data object for the row
            ...
            var table=$('#example').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo base_url(); ?>index.php/sqldata/writtenByAuthor/"+"<?php echo $authorInfo->author_id; ?>",
                "columns": [
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> <?php echo $authorInfo->name; ?>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="well">
                    ...
                    <label><b>Name:</b></label><i><?php echo $authorInfo->name; ?></i><br>
                    <label><b>Nddress:</b></label><i><?php echo $authorInfo->address; ?></i><br>
                    <label><b>Contact:</b></label><i><?php echo $authorInfo->contact_no; ?></i><br>
                    <label><b>Email Address:</b></label><i><?php echo $authorInfo->email; ?></i><br>
                    <label><b>Website:</b></label><i><a href="<?php echo prep_url($authorInfo->website); ?>"><?php echo $authorInfo->website; ?></a></i><br>
                </div> 

                <h4></h4>
                <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i><b> Books Written by <?php echo $authorInfo->name; ?> :</b>
                            </li>
                        </ol>
                <div>
